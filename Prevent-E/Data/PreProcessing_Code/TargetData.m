...
if eliminateStringColumn
    ...
    unifiedfile = "targetNormal_" + entries(2) + "_Unified_Ordered" + "_NOstrings.csv";
else
    unifiedfile = "targetNormal_" + nKPI + "_Unified_Ordered.csv";
end
...
if ~exist(tempDir + unifiedfile, "file")
    ...
    csvname = "targetNormal_" + totKPI + "_" + method + ".csv";
